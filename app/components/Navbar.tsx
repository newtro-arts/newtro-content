...
const Navbar = () => {
  return (
    <header className="fixed top-0 left-0 w-full bg-primary z-10 flex justify-between items-center">
      ...
      <div className="hidden sm:flex w-full items-center justify-between space-x-4 px-4">
        <Image src="/logo-web.svg" className="text-xl font-bold" width={180} height={70} alt=""></Image>
        <ProfileInfo/>
        <ConnectButton />
        <div className='flex gap-x-2 items-center'>
            <Search/>
            <RiNotification4Line className='border border-green-fourth p-4 rounded-lg' size={50}/>
        </div>
      </div>
    </header>
  )
